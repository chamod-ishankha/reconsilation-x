...
const LoginForm: FC = () => {
  ...
  return (
    <div className="login-page" style={{ backgroundColor: token.colorBgContainer }}>
      <Form<LoginParams> onFinish={onFinished} className="signup-page-form" initialValues={initialValues}>
          ...
          rules={[
            {
              ...
              message: formatMessage({
                id: 'gloabal.tips.enterCompanyNameMessage',
              }),
            },
          ]}
        >
